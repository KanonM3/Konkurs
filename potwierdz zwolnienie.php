...
<body>
    ...
    <div id="potwierdz">
        <h1 id="potwierdz-h1">Zatwierdz zwolnienie</h1>
        <h2 id="potwierdz-h2">Uczeń:</h2>
        <p id="potwierdz-p">Adolf Stalin</p>
        <h2 id="potwierdz-h2">Powód:</h2>
        <p id="potwierdz-p">Złamana noga</p>
        <h2 id="potwierdz-h2">Termin:</h2>
        <p id="potwierdz-p">24.04.2024-24.05.2024</p>
        <h2 id="potwierdz-h2">Klasa:</h2>
        <p id="potwierdz-p">2TP</p>
        <h2 id="potwierdz-h2">Zdjęcie:</h2>
        <p id="potwierdz-p">(dodajcie zdjecie ble bleble)</p>
        <form method="post">
            <input type="submit" name="potwierdzPrzycisk" id="potwierdzPrzycisk" value="Potwierdź">
            <input style="background-color: rgb(218, 0, 0);" id="odrzućPrzycisk" type="submit" name="odrzućPrzycisk" id="odrzućPrzycisk" value="Odrzuć">
        </form>
    </div>
</body>
</html>