...
<body>
    <div id="topnav">
        <ul id="topnav-ul">
            ...
            <li class="topnav-li"><a class="topnav-a" href="nauczyciel.php">Start<div class="underline"></div></a></li>
            <li class="topnav-li"><a class="topnav-a" href="nauczyciel.php">Twoje zwolnienia<div class="underline"></div></a></li>
